                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            <div className='flex items-center'>
                                {iconLists.map((icon, index) => 
                                    <div key={icon} className='rounded-full bg-black lg:w-10 lg:h-10 flex justify-center items-center border border-white/[0.2]' style={{transform: `translateX(-${5 * index * 2} px)`}}>
                                        <img 
                                            src={icon}
                                            alt={icon}
                                            className='p-2'
